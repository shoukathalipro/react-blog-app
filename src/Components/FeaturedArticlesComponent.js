...
const FeaturedArticlesComponent = () => {
    ...
    // const [bollywood] = useContext(BlogContext);
    // const [hollywood] = useContext(BlogContext);
...
// 
// <div key={index} className={styles.featured_Articles_Box_Big} style={   {backgroundImage: `url(${bollywood[bollywood.length - 1].ImageAsset})`,
//     backgroundPosition: 'center',
//     backgroundSize: 'cover',
//     backgroundRepeat: 'no-repeat' }  }>
//     <NavLink to={`/article/${article.Title}`} className={styles.Box_Big_Title}>{bollywood[bollywood.length - 1].Title}</NavLink>
//     <div className={styles.Box_Category_Date}>
//         <span>{bollywood[bollywood.length - 1].CategoryName}</span>
//         <span> / </span>
//         <span>{bollywood[bollywood.length - 1].PublishedDate}</span>
//     </div>
// </div>