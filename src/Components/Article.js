    ...
    return(
        <div className={ styles.Article_Main }>
           <div className={ styles.Article_Content }>
              {
                 bollywood.map(  (article, index) => article.Title === articleTitle&&
                    <div key={index} className={ styles.Article_Card }>
                            <div className={ styles.Article_Card_Top }>
                                    ...
                                    <div className={ styles.Article_Card_Top2 }>
                                            <div className={ styles.Card_Top2_Left }>
                                                    <div className={ styles.Card_Top2_Left1 }><i class="fas fa-user-circle fa-3x"></i></div>
                                            ...
                                            <div className={ styles.Card_Top2_Right }>
                                                    <div><i class="fab fa-facebook-square fa-lg"></i></div>
                                                    <div><i class="fab fa-twitter-square fa-lg"></i></div>
                                                    <div><i class="fab fa-instagram-square fa-lg"></i></div>
                                                    <div><i class="fab fa-youtube-square fa-lg"></i></div>
                                            </div>
                                    </div>
                            </div>
                            ...
                            <div className={ styles.Article_Card_Bottom }>
                                    <div className={ styles.Article_Card_Bottom1 }>
                                            <div><button><i class="far fa-thumbs-up fa-lg"></i></button></div>
                                            <div>{ article.Likes } Likes</div>
                                    </div>
                                    <div className={ styles.Article_Card_Bottom2 }>
                                            <div className={ styles.Article_Card_Bottom2A }><i class="fas fa-user-circle fa-3x"></i></div>
